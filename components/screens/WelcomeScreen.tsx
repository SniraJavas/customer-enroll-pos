...
const WelcomeScreen = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-green-50 to-green-100 p-6">
      {/* Header */}
      ...
      <button
        ...
        className="w-full bg-green-600 hover:bg-green-700 active:bg-green-800 text-white py-4 rounded-2xl font-semibold text-lg shadow-lg transition-colors duration-150 mb-4"
      >
        Get Started
      </button>
